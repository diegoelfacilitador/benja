...
// Uses CSS variables compatible with EF Hub's data-theme system
//
// Required CSS variables (add to your globals.css if not present):
// --color-bg, --color-surface, --color-border, --color-text,
// --color-text-secondary, --color-primary, --color-primary-text,
// --color-success, --color-warning, --color-error, --color-muted
