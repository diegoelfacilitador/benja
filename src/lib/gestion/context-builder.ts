// Context builder for Centro AI
// Assumes Supabase client is available via @/lib/supabase/server (EF Hub's existing setup)

import { createClient } from "@/lib/supabase/server"
import type { Task, FinancialEntry, FinancialTarget, CalendarEvent } from "@/types/gestion"
